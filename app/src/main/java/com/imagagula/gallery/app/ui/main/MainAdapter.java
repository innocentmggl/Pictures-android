...
public class MainAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public MainAdapter(List<PictureResponse.Photo.Photos> blogResponseList) {
        ...
        switch (viewType) {
            case VIEW_TYPE_NORMAL:
                return new ViewHolder(
                        LayoutInflater.from(parent.getContext()).inflate(R.layout.adapater_main, parent, false));
